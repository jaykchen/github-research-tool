...
pub async fn correlate_commits_issues_discussions(
    ...
    let trim_to_allocated_space =
        |source: &str| -> String { source.chars().take(allocated_space_per_data * 3).collect() };
